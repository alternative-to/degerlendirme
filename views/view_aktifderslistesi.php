...
echo "Birinci Grubun anahtar değeri (azami 10 karakter) :";
echo "<input type='text' name='birgrupanahtar'><br />\r\n";
echo "İkinci Grubun ismi: ";
echo "<input type='text' name='ikigrupisim'><br />\r\n";
echo "İkinci Grubun anahtar değeri (azami 10 karakter) :";
echo "<input type='text' name='ikigrupanahtar'><br />\r\n";
